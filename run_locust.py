...
# Save the script dynamically as 'locustfile.py'
with open("locustfile.py", "w") as f:
    f.write(locust_script)

# Run Locust using os.system
os.system("locust --host=https://official-joke-api.appspot.com/random_joke --users 50 --spawn-rate 5 --run-time 5m --headless --html report.html")